...
public class CarMainStory extends  JUnitStories  {
	...
	public InjectableStepsFactory stepsFactory() {
		return new InstanceStepsFactory(configuration(), new CarLightSteps());
	}
 
	@Override
	protected List<String> storyPaths() {   
		return Arrays.asList("phare/CarLightReq.story");
	}
}
